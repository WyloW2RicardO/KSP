...
def dimension_moin(matrice, d = 2) :
    pass
...
moteur = 1
fuse0_0plan, fuse0_1moteur, fuse0_2kg_vid, fuse0_3kg_fuel, fuse0_4kg_total, fuse0_5cout = etage_plus(moteur, fuse0_0plan, fuse0_1moteur, fuse0_2kg_vid, fuse0_3kg_fuel, fuse0_4kg_total, fuse0_5cout)
# print("fuse0_0plan", numpy.array(fuse0_0plan))
...
for i0 in range(Q0):
    ...
    fuse0_0plan[i0], fuse0_1moteur[i0], fuse0_2kg_vid[i0], fuse0_3kg_fuel[i0], fuse0_4kg_total[i0], fuse0_5cout[i0] = etage_plus(moteur, fuse0_0plan[i0], fuse0_1moteur[i0], fuse0_2kg_vid[i0], fuse0_3kg_fuel[i0], fuse0_4kg_total[i0], fuse0_5cout[i0])
    # print("fuse0_0plan", "[", i0, "]", numpy.array(fuse0_0plan[i0]))
...
for i0 in range(Q0) :
    ...
    for i1 in range(Q1) :
        fuse1_0plan[i1], fuse1_1moteur[i1], fuse1_2kg_vid[i1], fuse1_3kg_fuel[i1], fuse1_4kg_total[i1], fuse1_5cout[i1] = etage_plus(moteur, fuse1_0plan[i1], fuse1_1moteur[i1], fuse1_2kg_vid[i1], fuse1_3kg_fuel[i1], fuse1_4kg_total[i1], fuse1_5cout[i1])
