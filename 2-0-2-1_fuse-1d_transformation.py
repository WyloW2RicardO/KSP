...
fuse0_plan     = liste2liste(fuse0_plan)
fuse1_moteur   = liste2liste(fuse1_moteur)
fuse2_kg_vid   = liste2liste(fuse2_kg_vid)
fuse3_kg_fuel  = liste2liste(fuse3_kg_fuel)
fuse4_kg_total = liste2liste(fuse4_kg_total)
fuse5_cout     = liste2liste(fuse5_cout)
