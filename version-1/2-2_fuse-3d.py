...
fuse0_plan    =[[[[0,0,0]    for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
fuse1_moteur  =[[[-1         for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
fuse2_kg_vid  =[[[charg_kg   for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
fuse3_kg_fuel =[[[0          for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
fuse4_kg_total=[[[0          for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
fuse5_cout    =[[[charg_cout for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
...
for i0 in range(q):
    for i1 in range(q):
        for i2 in range(q):
            ...
            if i2 > 0 :
                nombre                   =i2
                fuse1_moteur[i0][i1][i2] =3
                fuse2_kg_vid[i0][i1][i2] =fuse2_kg_vid[i0][i1][0]
                fuse5_cout[i0][i1][i2]   =fuse5_cout[i0][i1][0]
                fuse2_kg_vid[i0][i1][i2]+=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1][i2]][masse]
                fuse5_cout[i0][i1][i2]  +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1][i2]][cout]
            else :
                if i1 > 0 :
                    nombre                   =i1
                    fuse1_moteur[i0][i1][i2] =2
                    fuse2_kg_vid[i0][i1][i2] =fuse2_kg_vid[i0][0][0]
                    fuse5_cout[i0][i1][i2]   =fuse5_cout[i0][0][0]
                    fuse2_kg_vid[i0][i1][i2]+=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1][i2]][masse]
                    fuse5_cout[i0][i1][i2]  +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1][i2]][cout]
                elif i0 > 0 :
                    nombre                   =i0
                    fuse1_moteur[i0][i1][i2] =1
                    fuse2_kg_vid[i0][i1][i2]+=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1][i2]][masse]
                    fuse5_cout[i0][i1][i2]  +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1][i2]][cout]
            fuse0_plan[i0][i1][i2] =[i0,i1,i2]
            fuse2_kg_vid[i0][i1][i2] +=nombre*tanks[1][masse]
            fuse3_kg_fuel[i0][i1][i2] =fuel_kg(nombre)
            fuse4_kg_total[i0][i1][i2]=fuse2_kg_vid[i0][i1][i2]+fuse3_kg_fuel[i0][i1][i2]
            fuse5_cout[i0][i1][i2]   +=fuel_c(nombre)+nombre*tanks[1][cout]

Z = 1
if Z > 0 :
    fuse6_rpp    =[[[0 for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
    fuse7_agravit=[[[0 for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
    for i0 in range(q):
        for i1 in range(q):
            for i2 in range(q):
                fuse6_rpp[i0][i1][i2]    =RPP(     fuse4_kg_total[i0][i1][i2],typ,fuse1_moteur[i0][i1][i2],0)
                fuse7_agravit[i0][i1][i2]=a_GRAVIT(fuse4_kg_total[i0][i1][i2],typ,fuse1_moteur[i0][i1][i2],0)

    min0_dv = escap(70000)
    for i0 in range(q):
        for i1 in range(q):
            for i2 in range(q):
                if fuse7_agravit[i0][i1][i2] < 1 or fuse6_rpp[i0][i1][i2] <1 :
                    fuse5_cout[i0][i1][i2]   =0
    if Z > 1:            
        # fuse8_deltav =[[[0 for i2 in range(q)] for i1 in range(q)] for i0 in range(q)]
        ...
        for i0 in range(q):
            for i1 in range(q):
                for i2 in range(q):
                    if fuse5_cout[i0][i1][i2] != 0:
                        if min2_cout == 0:
                            min1_plan = fuse0_plan[i0][i1][i2]
                            min2_cout = fuse5_cout[i0][i1][i2]
                        elif fuse5_cout[i0][i1][i2] < min2_cout:
                            min1_plan = fuse0_plan[i0][i1][i2]
                            min2_cout = fuse5_cout[i0][i1][i2]
                        elif fuse5_cout[i0][i1][i2] == min2_cout and i0>i1:
                            min1_plan = fuse0_plan[i0][i1][i2]
                            min2_cout = fuse5_cout[i0][i1][i2]