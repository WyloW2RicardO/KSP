...
for i0 in range(q):
    ...
    fuse2_kg_vid[i0][i1] +=i0*tanks[1][masse]
    fuse3_kg_fuel[i0][i1] =fuel_kg(i0)
    fuse4_kg_total[i0][i1]=fuse2_kg_vid[i0][0]+fuse3_kg_fuel[i0][i1]
    fuse5_cout[i0][i1]   +=fuel_c(i0)+i0*tanks[1][cout]
    for i1 in range(1,q):
        ...
        fuse2_kg_vid[i0][i1] +=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1]][masse]
        fuse5_cout[i0][i1]   +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1]][cout]
        fuse2_kg_vid[i0][i1] +=i1*tanks[1][masse]
        fuse3_kg_fuel[i0][i1] =fuel_kg(i0)
        fuse4_kg_total[i0][i1]=fuse2_kg_vid[i0][0]+fuse3_kg_fuel[i0][i1]
        fuse5_cout[i0][i1]   +=fuel_c(i0)+i1*tanks[1][cout]
