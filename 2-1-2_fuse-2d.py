...
fuse0_plan    =[[[0,0]      for i1 in range(q)] for i0 in range(q)]
fuse1_moteur  =[[-1         for i1 in range(q)] for i0 in range(q)]
fuse2_kg_vid  =[[charg_kg   for i1 in range(q)] for i0 in range(q)]
fuse3_kg_fuel =[[0          for i1 in range(q)] for i0 in range(q)]
fuse4_kg_total=[[0          for i1 in range(q)] for i0 in range(q)]
fuse5_cout    =[[charg_cout for i1 in range(q)] for i0 in range(q)]

for i0 in range(q):
    for i1 in range(q):
        nombre=0
        if i1 > 0 :
            fuse0_plan[i0][i1][0] =fuse0_plan[i0][0][0]
            fuse0_plan[i0][i1][1]+=1
            nombre               =i1
            fuse1_moteur[i0][i1] =3
            fuse2_kg_vid[i0][i1] =fuse2_kg_vid[i0][0]
            fuse5_cout[i0][i1]   =fuse5_cout[i0][0]
            fuse2_kg_vid[i0][i1]+=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1]][masse]
            fuse5_cout[i0][i1]  +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1]][cout]
        elif i0 > 0 :
            fuse0_plan[i0][i1][0]+=1
            nombre               =i0
            fuse1_moteur[i0][i1] =1
            fuse2_kg_vid[i0][i1]+=coupling[typ][1][masse]+engeins[typ][fuse1_moteur[i0][i1]][masse]
            fuse5_cout[i0][i1]  +=coupling[typ][1][cout] +engeins[typ][fuse1_moteur[i0][i1]][cout]
        fuse2_kg_vid[i0][i1] +=nombre*tanks[1][masse]
        fuse3_kg_fuel[i0][i1] =fuel_kg(nombre)
        fuse4_kg_total[i0][i1]=fuse2_kg_vid[i0][i1]+fuse3_kg_fuel[i0][i1]
        fuse5_cout[i0][i1]   +=fuel_c(nombre)+nombre*tanks[1][cout]