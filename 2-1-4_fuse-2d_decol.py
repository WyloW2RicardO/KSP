...
if Z > 0 :
    ...
    fuse1_6rpp    =[[0 for i1 in range(q)] for i0 in range(q)]
    fuse1_7agravit=[[0 for i1 in range(q)] for i0 in range(q)]
    for i0 in range(q):
        for i1 in range(q):
            fuse1_6rpp[i0][i1]    = RPP(fuse0_4kg_total[i0][i1],typ,fuse0_1moteur[i0][i1],0)
            fuse1_7agravit[i0][i1]= a_GRAVIT(fuse0_4kg_total[i0][i1],typ,fuse0_1moteur[i0][i1],0)

    for i0 in range(q):
        for i1 in range(q):
            if fuse1_7agravit[i0][i1] < 1 or fuse1_6rpp[i0][i1] <1 :
                fuse0_5cout[i0][i1] = 0
    
if Z > 1 :
    min0_dv = escap(70000)
    fuse1_8deltav =[[0 for i1 in range(q)] for i0 in range(q)]
    fuse1_8deltav[i0][i1] = D_v(fuse0_2kg_vid[i0][i1],fuse0_3kg_fuel[i0][i1],typ,fuse0_1moteur[i0][i1],0)
