...
def dimension_plus(fuse0_0plan_liste,
                   fuse0_1moteur_liste,
                   fuse0_2kg_vid_liste,
                   fuse0_3kg_fuel_liste,
                   fuse0_4kg_total_liste,
                   fuse0_5cout_liste):
    fuse2_0plan     = liste2liste(fuse0_0plan_liste)
    fuse2_1moteur   = liste2liste(fuse0_1moteur_liste)
    fuse2_2kg_vid   = liste2liste(fuse0_2kg_vid_liste)
    fuse2_3kg_fuel  = liste2liste(fuse0_3kg_fuel_liste)
    fuse2_4kg_total = liste2liste(fuse0_4kg_total_liste)
    fuse2_5cout     = liste2liste(fuse0_5cout_liste)
    # print(fuse2_1moteur)
    Q1 = len(fuse2_0plan)
    for i1 in range(Q1):
        fuse1_0plan, fuse1_1moteur, fuse1_2kg_vid, fuse1_3kg_fuel, fuse1_4kg_total, fuse1_5cout = construc(moteur, fuse2_0plan[i1], fuse2_1moteur[i1], fuse2_2kg_vid[i1], fuse2_3kg_fuel[i1], fuse2_4kg_total[i1], fuse2_5cout[i1])
        # print("fuse2_1moteur","[",i1,"]", fuse2_1moteur[i1])
        # print("fuse1_1moteur", fuse1_1moteur)
        fuse2_0plan[i1]     = [numpy.append(fuse2_0plan[i1][0],fuse1_0plan[i2]) for i2 in range(len(fuse1_0plan))]
        fuse2_1moteur[i1]   = fuse1_1moteur
        fuse2_2kg_vid[i1]   = fuse1_2kg_vid
        fuse2_3kg_fuel[i1]  = fuse1_3kg_fuel
        fuse2_4kg_total[i1] = fuse1_4kg_total
        fuse2_5cout[i1]     = fuse1_5cout
    return fuse2_0plan, fuse2_1moteur, fuse2_2kg_vid, fuse2_3kg_fuel, fuse2_4kg_total, fuse2_5cout
...
moteur = 2
fuse0_0plan, fuse0_1moteur, fuse0_2kg_vid, fuse0_3kg_fuel, fuse0_4kg_total, fuse0_5cout = dimension_plus(fuse0_0plan, fuse0_1moteur, fuse0_2kg_vid, fuse0_3kg_fuel, fuse0_4kg_total, fuse0_5cout)
# dim = 2

moteur = 3
Q0 = len(fuse0_0plan)
for i0 in range(Q0):
    fuse0_0plan[i0], fuse0_1moteur[i0], fuse0_2kg_vid[i0], fuse0_3kg_fuel[i0], fuse0_4kg_total[i0], fuse0_5cout[i0] = dimension_plus(fuse0_0plan[i0], fuse0_1moteur[i0], fuse0_2kg_vid[i0], fuse0_3kg_fuel[i0], fuse0_4kg_total[i0], fuse0_5cout[i0])
